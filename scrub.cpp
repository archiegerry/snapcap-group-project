...
void Scrub::createWidgets()
{
    ...
    QPushButton * addaudio = new QPushButton();
    addaudio->setMaximumSize(25,25);
    addaudio->setText("+");
    audiobarLayout->addWidget(addaudio);
    QPushButton * addvideo = new QPushButton();
    addvideo->setMaximumSize(25,25);
    addvideo->setText("+");
    videobarLayout->addWidget(addvideo);
